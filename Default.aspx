...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="introWrapper">
        <asp:Label runat="server" Font-Bold="true" Font-Names="Lucida Sans" Font-Size="XX-Large" Fo Text="Welcome!"></asp:Label>
        <br />
        <p class="info">
        ...
        <asp:Label runat="server" Font-Bold="true" Font-Names="Lucida Sans" Font-Size="X-Large" Text="Inventory Manager"></asp:Label>
        <br />
        <p class="info">
        ...
        <br /><br />
        <asp:Label runat="server" Font-Bold="true" Font-Names="Lucida Sans" Font-Size="X-Large" Text="Barcode Manager"></asp:Label>
        <br />
        <p class="info">
